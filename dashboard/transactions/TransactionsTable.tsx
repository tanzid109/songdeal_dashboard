...
export default function TransactionTable() {
    ...
    const columns: ColumnDef<Transaction>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className="text-center font-medium">{row.original.date}</div>
            ),
        },
        {
            accessorKey: "investor",
            header: () => <div className="text-center">Investor</div>,
            cell: ({ row }) => (
                <div className="text-center font-medium">{row.original.investor}</div>
            ),
        },
        {
            accessorKey: "status",
            ...
            cell: ({ row }) => {
                ...
                return (
                    <p
                        className={`text-center px-2 mx-auto py-1 rounded-md font-medium capitalize ${color}`}
                    >
                        {status}
                    </p>
                );
            ...
            cell: () => {
                ...
                return (
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <button
                            className="bg-[#635BFF1A] px-4 py-2 rounded-md flex items-center justify-center text-[#635BFF] hover:bg-[#faad14bd] hover:text-black transition cursor-pointer"
                            title="View"
                            // onClick={() => handleView(user)}
                        >
                            <p>Approve</p>
